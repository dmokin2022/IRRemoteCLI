...
class KeyReaction: public IRrecv  {
    public:
        key_data_t* pultButtonTable;    // указетель на таблицу кодов кнопок и обработчиков
        ...
        KeyReaction(int _recvpin, key_data_t* _pultButtonTable, uint8_t _pultButtonTableSize):IRrecv(_recvpin) {
        ...
        void outputKey(uint16_t keyNum);
